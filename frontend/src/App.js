...
function App() {
  ...
  <ul>
    <li> Если вы используете съёмочный материал, отснятый в студии, для создания ИИ-аватаров, дипфейков или генеративного контента, студия оставляет за собой право:

приостановить съёмку без возврата оплаты

подать претензию на авторские права на использованные фоны/объекты/свет, если они явно распознаются и принадлежат студии </li>
    <li>📚 Согласно Закону Республики Узбекистан «Об авторском праве и смежных правах» (статья 5), объектами авторского права признаются:

Произведения архитектуры, дизайна интерьера, декора, и иные произведения, созданные в результате творческой деятельности.
</li>
    <li>📌 Это означает, что использование узнаваемого пространства или элементов студии в коммерческих ИИ-проектах может нарушать авторские права владельца студии, если предварительно не согласовано.</li>
  </ul>
</div>
